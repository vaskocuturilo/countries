...
-> REST API (/api/v1/process) <-> External REST API (
Countries: https://restcountries.com/v3.1/all?fields=cca2,cca3,capital,region,subregion,area,population,independent) \
